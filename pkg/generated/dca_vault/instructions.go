...
var ProgramID ag_solanago.PublicKey = ag_solanago.MustPublicKeyFromBase58("TAMsKAQM1zTjMdjXSJzRLnWV7uZGtvv6ej8eZSBYhcw")
...
var (
	...
	Instruction_DepositA = ag_binary.TypeID([8]byte{79, 43, 133, 174, 228, 157, 216, 118})

	Instruction_WithdrawA = ag_binary.TypeID([8]byte{120, 193, 241, 208, 58, 216, 211, 99})
...
func InstructionIDToName(id ag_binary.TypeID) string {
	...
	case Instruction_InitVault:
		return "InitVault"
	case Instruction_DepositA:
		return "DepositA"
	case Instruction_WithdrawA:
		return "WithdrawA"
...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		...
		{
			"deposit_a", (*DepositA)(nil),
		},
		{
			"withdraw_a", (*WithdrawA)(nil),
		},
		{
