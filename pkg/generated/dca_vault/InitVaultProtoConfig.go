...
func (inst *InitVaultProtoConfig) SetGranularity(granularity uint64) *InitVaultProtoConfig {
			...
			programBranch.Child(ag_format.Instruction("InitVaultProtoConfig")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=3]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						accountsBranch.Child(ag_format.Meta("vaultProtoConfig", inst.AccountMetaSlice[0]))
