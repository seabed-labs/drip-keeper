			...
			programBranch.Child(ag_format.Instruction("Deposit")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=13]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("        vaultPeriodEnd", inst.AccountMetaSlice[1]))
						accountsBranch.Child(ag_format.Meta("          userPosition", inst.AccountMetaSlice[2]))
						accountsBranch.Child(ag_format.Meta("            tokenAMint", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("   userPositionNftMint", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("           vaultTokenA", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("            userTokenA", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("       userPositionNft", inst.AccountMetaSlice[7]))
						accountsBranch.Child(ag_format.Meta("             depositor", inst.AccountMetaSlice[8]))
