			...
			programBranch.Child(ag_format.Instruction("WithdrawB")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=14]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("       userPositionNft", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("           vaultTokenB", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("            userTokenB", inst.AccountMetaSlice[7]))
						accountsBranch.Child(ag_format.Meta("   vaultTreasuryTokenB", inst.AccountMetaSlice[8]))
						accountsBranch.Child(ag_format.Meta("   userPositionNftMint", inst.AccountMetaSlice[9]))
						accountsBranch.Child(ag_format.Meta("            tokenBMint", inst.AccountMetaSlice[10]))
						accountsBranch.Child(ag_format.Meta("            withdrawer", inst.AccountMetaSlice[11]))
						accountsBranch.Child(ag_format.Meta("          tokenProgram", inst.AccountMetaSlice[12]))
						accountsBranch.Child(ag_format.Meta("associatedTokenProgram", inst.AccountMetaSlice[13]))
					})
				})
		})
}
