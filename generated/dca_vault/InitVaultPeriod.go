			...
			programBranch.Child(ag_format.Instruction("InitVaultPeriod")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=7]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						accountsBranch.Child(ag_format.Meta("     vaultPeriod", inst.AccountMetaSlice[0]))
						accountsBranch.Child(ag_format.Meta("           vault", inst.AccountMetaSlice[1]))
						accountsBranch.Child(ag_format.Meta("      tokenAMint", inst.AccountMetaSlice[2]))
						accountsBranch.Child(ag_format.Meta("      tokenBMint", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("vaultProtoConfig", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("         creator", inst.AccountMetaSlice[5]))
