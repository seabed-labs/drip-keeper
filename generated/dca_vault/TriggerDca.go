			...
			programBranch.Child(ag_format.Instruction("TriggerDca")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=20]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("       lastVaultPeriod", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("    currentVaultPeriod", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("         swapTokenMint", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("            tokenAMint", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("            tokenBMint", inst.AccountMetaSlice[7]))
						accountsBranch.Child(ag_format.Meta("           vaultTokenA", inst.AccountMetaSlice[8]))
						accountsBranch.Child(ag_format.Meta("           vaultTokenB", inst.AccountMetaSlice[9]))
