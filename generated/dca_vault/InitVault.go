			...
			programBranch.Child(ag_format.Instruction("InitVault")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=12]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("                tokenA", inst.AccountMetaSlice[2]))
						accountsBranch.Child(ag_format.Meta("                tokenB", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("        treasuryTokenB", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("            tokenAMint", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("            tokenBMint", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("               creator", inst.AccountMetaSlice[7]))
						accountsBranch.Child(ag_format.Meta("          tokenProgram", inst.AccountMetaSlice[8]))
						accountsBranch.Child(ag_format.Meta("associatedTokenProgram", inst.AccountMetaSlice[9]))
